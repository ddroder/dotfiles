...
var require_polyfills = __commonJS({
  "node_modules/graceful-fs/polyfills.js"(exports2, module2) {
    ...
    function patch(fs3) {
      ...
      if (platform === "win32") {
        fs3.rename = /* @__PURE__ */ function(fs$rename) {
      ...
      fs3.readSync = /* @__PURE__ */ function(fs$readSync) {
...
var require_remove = __commonJS({
  "node_modules/fs-extra/lib/remove/index.js"(exports2, module2) {
    ...
    function remove(path2, callback) {
      if (fs3.rm) return fs3.rm(path2, { recursive: true, force: true }, callback);
      rimraf(path2, callback);
    }
    function removeSync(path2) {
      if (fs3.rmSync) return fs3.rmSync(path2, { recursive: true, force: true });
      rimraf.sync(path2);
    }
    module2.exports = {
      remove: u(remove),
...
`);
              ...
              if (200 === m) {
                if (e3.once("socket", h), t3.secureEndpoint) {
                  ...
                  if (!e4) throw new Error('Could not determine "servername"');
        ...
        function g(e3) {
          ...
          return new Promise(function(r3, o3) {
            var u2 = (0, n2.parse)(e3.url), i2 = { hostname: u2.hostname, agent: !!e3.agent && e3.agent, port: u2.port ? parseInt(u2.port) : "https:" === u2.protocol ? 443 : 80, path: u2.path, method: e3.type || "GET", headers: e3.headers, rejectUnauthorized: "boolean" != typeof e3.strictSSL || e3.strictSSL };
            ...
            (t3 = "https:" === u2.protocol ? s.request(i2, c2) : a.request(i2, c2)).on("error", o3), e3.timeout && t3.setTimeout(e3.timeout), e3.data && t3.write(e3.data), t3.end();
          });
        }
        t2.configure = function(e3, t3) {
          p = e3, h = t3;
        }, t2.xhr = function(e3) {
          return "boolean" != typeof (e3 = o2({}, e3)).strictSSL && (e3.strictSSL = h), e3.agent || (e3.agent = function(e4, t3) {
            void 0 === t3 && (t3 = {});
            ...
            if (!/^https?:$/.test(s2.protocol)) return null;
            var a2 = { host: s2.hostname, port: Number(s2.port), auth: s2.auth, rejectUnauthorized: "boolean" != typeof t3.strictSSL || t3.strictSSL, protocol: s2.protocol };
            return "http:" === r3.protocol ? l(a2) : c(a2);
          }(e3.url, { proxyUrl: p, strictSSL: h })), "number" != typeof e3.followRedirects && (e3.followRedirects = 5), g(e3).then(function(r3) {
            return new Promise(function(o3, s2) {
              var a2, i2, c2 = r3.res, l2 = c2, d2 = false, p2 = c2.headers && c2.headers["content-encoding"];
              if (p2 && (a2 = e3.type, i2 = r3.res.statusCode, !("HEAD" === a2 || i2 >= 100 && i2 < 200 || 204 === i2 || 304 === i2))) {
              ...
              l2.on("data", function(e4) {
                ...
                if (!d2) {
                  if (d2 = true, e3.followRedirects > 0 && (c2.statusCode >= 300 && c2.statusCode <= 303 || 307 === c2.statusCode)) {
                  ...
                  c2.statusCode >= 200 && c2.statusCode < 300 || 1223 === c2.statusCode ? o3(l3) : s2(l3);
                }
        ...
        function y(e3) {
          ...
          if (t3 && (e3 = e3.substr(0, e3.length - t3.length)), c.messageFormat === a.MessageFormat.both || c.messageFormat === a.MessageFormat.bundle) {
            ...
            if (r3) {
              ...
              if (u2) {
                ...
                return void 0 === v2 ? (console.error("Messages for file " + e3 + " not found. See console for details."), function() {
          ...
          if (c.messageFormat === a.MessageFormat.both || c.messageFormat === a.MessageFormat.file) try {
            var y2 = p(function(e4) {
              var t4;
              if (c.cacheLanguageResolution && t4) t4 = t4;
              else {
        ...
        function b(e3) {
          return e3 && (f(e3.locale) && (c.locale = e3.locale.toLowerCase(), c.language = c.locale, i = /* @__PURE__ */ Object.create(null)), void 0 !== e3.messageFormat && (c.messageFormat = e3.messageFormat), e3.bundleFormat === a.BundleFormat.standalone && true === c.languagePackSupport && (c.languagePackSupport = false)), a.setPseudo("pseudo" === c.locale), y;
        }
        !function() {
          ...
          a.setPseudo("pseudo" === c.locale), i = /* @__PURE__ */ Object.create(null);
...
((SchemaModificationNotification2) => {
...
var StatusBar = class {
  ...
  async checkDocument(doc) {
    ...
    if (doc.languageId === "yaml") {
      ...
      if (import_coc2.workspace.bufnr != doc.bufnr) return;
...
async function getJsonSchemaContent(uri, schemaCache) {
  ...
  (0, import_request_light.configure)(httpSettings.http && httpSettings.http.proxy, httpSettings.http && httpSettings.http.proxyStrictSSL);
  const headers = { "Accept-Encoding": "gzip, deflate" };
  if (cachedETag) {
    headers["If-None-Match"] = cachedETag;
  }
  return (0, import_request_light.xhr)({ url: uri, followRedirects: 5, headers }).then(async (response) => {
    ...
    if (error.status === 304) {
      ...
      if (content === void 0) {
        ...
        return (0, import_request_light.xhr)({ url: uri, followRedirects: 5, headers }).then((response) => {
          return response.responseText;
        }).catch((err) => {
...
function createReject(error) {
  return Promise.reject(error.responseText || (0, import_request_light.getErrorStatusDescription)(error.status) || error.toString());
}
...
((SchemaAssociationNotification2) => {
  SchemaAssociationNotification2.type = new import_coc5.NotificationType(
...
((VSCodeContentRequestRegistration2) => {
...
((ResultLimitReachedNotification2) => {
...
function activate(context) {
  ...
  context.subscriptions.push(import_coc5.listManager.registerList(new SchemaList(client)));
  ...
  const statusBarItem = new StatusBar(client);
  context.subscriptions.push(statusBarItem);
  context.subscriptions.push(
    import_coc5.workspace.registerTextDocumentContentProvider(
      "json-schema",
  ...
  client.onReady().then(() => {
    ...
    client.onRequest(FSReadFile.type, (fsPath) => {
      return (0, import_util.promisify)(import_fs.default.readFile)(fsPath, "utf8");
    });
    ...
    client.onNotification(ResultLimitReachedNotification.type, async (message) => {
      ...
      if (shouldPrompt) {
        ...
        const pick = await import_coc5.window.showInformationMessage(
          `${message}
